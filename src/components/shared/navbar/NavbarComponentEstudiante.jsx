...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" >
  <div class="container-fluid">
    ...
    <a class="navbar-brand">Plataforma de Ventas HOW Estudiante</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
        {isAuthenticated ? <Link to="/avances" className="nav-link active" aria-current="page" >Avances en proyectos</Link> : <Link to="/forbiden" className="nav-link active" aria-current="page" >Avances en proyectos</Link> }
        </li>
      </ul>
    </div>
